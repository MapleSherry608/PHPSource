...
E_D("replace into `ecs_weixin_point` values('4','cxbd','10','1','no');");
E_D("replace into `ecs_weixin_point` values('5','ddcx','10','1','no');");
E_D("replace into `ecs_weixin_point` values('6','kdcx','10','1','no');");
