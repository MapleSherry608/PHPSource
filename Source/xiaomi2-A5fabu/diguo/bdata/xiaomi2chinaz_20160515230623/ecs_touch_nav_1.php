...
E_D("replace into `ecs_touch_nav` values('2','','0','我的订单','1','0','0','index.php?m=default&amp;c=user&amp;a=order_list','themes/default/images/nav/nav_1.png','middle');");
...
E_D("replace into `ecs_touch_nav` values('5','','0','热门搜索','1','0','0','javascript:openSearch();','themes/default/images/nav/nav_4.png','middle');");
E_D("replace into `ecs_touch_nav` values('6','','0','品牌街','1','0','0','index.php?m=default&amp;c=brand','themes/default/images/nav/nav_5.png','middle');");
...
E_D("replace into `ecs_touch_nav` values('8','','0','购物车','1','0','0','index.php?m=default&amp;c=flow&amp;a=cart','themes/default/images/nav/nav_7.png','middle');");
