...
E_D("replace into `ecs_template` values('index','全宽行','/library/cat_goods.lbi','3','391','5','1','ecmoban_xiaomi2015','');");
E_D("replace into `ecs_template` values('index','','/library/brands.lbi','0','0','5','0','ecmoban_xiaomi2015','');");
E_D("replace into `ecs_template` values('index','','/library/auction.lbi','0','0','5','0','ecmoban_xiaomi2015','');");
E_D("replace into `ecs_template` values('index','','/library/group_buy.lbi','0','0','5','0','ecmoban_xiaomi2015','');");
E_D("replace into `ecs_template` values('index','全宽行','/library/recommend_hot.lbi','1','0','5','0','ecmoban_xiaomi2015','');");
E_D("replace into `ecs_template` values('index','促销商品区域','/library/recommend_promotion.lbi','0','0','4','0','ecmoban_xiaomi2015','');");
E_D("replace into `ecs_template` values('index','全宽行','/library/recommend_new.lbi','0','0','5','0','ecmoban_xiaomi2015','');");
E_D("replace into `ecs_template` values('index','全宽行','/library/recommend_best.lbi','2','0','5','0','ecmoban_xiaomi2015','');");
E_D("replace into `ecs_template` values('index','商店公告','/library/new_articles.lbi','0','0','0','0','ecmoban_xiaomi2015','');");
E_D("replace into `ecs_template` values('index','商店公告下广告','/library/ad_position.lbi','0','159','1','4','ecmoban_xiaomi2015','');");
