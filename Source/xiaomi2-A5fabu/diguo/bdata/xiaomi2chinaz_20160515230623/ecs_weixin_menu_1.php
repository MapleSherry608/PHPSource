...
E_D("replace into `ecs_weixin_menu` values('49','首页','1','','','http://www.leerfa.com','2','1','40');");
E_D("replace into `ecs_weixin_menu` values('50','订阅号活动','1','','订阅号活动','','5','0','40');");
E_D("replace into `ecs_weixin_menu` values('51','最新公司公告','1','','公司公告','','4','0','40');");
