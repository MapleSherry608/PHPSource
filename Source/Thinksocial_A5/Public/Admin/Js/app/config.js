require.config({
	...
	paths: {
		...
		'datetimepicker': '../components/datetimepicker/datetimepicker.min',
		...
		'ZeroClipboard': "../components/ueditor/third-party/zeroclipboard/ZeroClipboard.min"//主要是加这句话
	},
	shim:{
		'jquery.ui': {
			exports: "$",
		...
		'datetimepicker' : {
			exports : '$',
			deps: ['jquery', 'css!../components/datetimepicker/datetimepicker.min.css']
		},
		'kindeditor': {
		...
		'select2': {
			deps: ['css!../components/select2/select2.min.css', '../components/select2/select2.min.js']
		}
	}
});