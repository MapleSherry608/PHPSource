	...
	function resetIndex(){
        ...
        function bindButton(){
            ...
            $("#dateconfirm").unbind('click').click(function () {
            	var selectYear = $("#yearwrapper ul li:eq("+indexY+")").html().substr(0,$("#yearwrapper ul li:eq("+indexY+")").html().length-1);
            	var selectMonth = $("#monthwrapper ul li:eq("+indexM+")").html().substr(0,$("#monthwrapper ul li:eq("+indexM+")").html().length-1);
            	var selectDay = $("#daywrapper ul li:eq("+Math.round(indexD)+")").html().substr(0,$("#daywrapper ul li:eq("+Math.round(indexD)+")").html().length-1);
                console.log("111"+selectDay+"222");
                var datestr = selectYear+"-"+selectMonth;
			  if(selectDay != "&nbsp"){
			  	datestr += "-"+selectDay;
			  }
               if(datetime){
