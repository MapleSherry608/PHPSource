    ...
    core.getUrl = function(routes,params,full) {
        ...
        if(params ){
            if(typeof(params)=='object') {
            	params = replaceAll(this.toQueryString(params));
                p+="/" + params;
        ...
        var url = window.location.pathname+"?s=home/"+todo+"/"+p;
        /*var url = this.options.baseUrl.replace('ROUTES', p);*/
      ...
      core.loading =  function() {
          var u = navigator.userAgent, app = navigator.appVersion;
           if ($('#core_loading').length <= 0) {
                $('body').append('<div id="core_loading" style="top:50%;left:50%;margin-left:-35px;margin-top:-30px;position:absolute;width:80px;z-index:999999"><img src="./Public/Static/shop/images/loading.svg" width="80" /></div>')
            }
            else{
                $('#core_loading').show();
            }
