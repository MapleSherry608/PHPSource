...
$(document).ready(function(e) {
	...
	$(".del").click(function(){
		 if(confirm("确定要删除吗")){
			 var id=$(this).attr("id");
			 window.location.href=APP_PATH+"/user/del_comment/id/"+id;
		 }else{
			 return false;
		 }
	});
            	...
            	<div class="orders_box">
                	<ul>
                    	...
                    	<li>
                            ...
                            <span>●&nbsp;内容：<font title="<{$datas[sn].content}>" class="red_l"><{$datas[sn].content|truncate:"50"}></font></span>
                            <span style="color:green">评论时间:<{$datas[sn].create_time}></span>
                             <span class="red_l"><a href="<{$datas[sn].url}>" target="_blank">文章链接</a></span>
