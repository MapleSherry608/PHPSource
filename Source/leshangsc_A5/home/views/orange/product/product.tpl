    ...
    <div class="product_box">
        ...
        <div class="content" id="products">
        	...
        	<div class="product">
                ...
                <div class="p_price"><span style="text-decoration:line-through;color:#666666">原价:&yen;<{$sub_nav_data[sn].products[n].origin_price}></span>&nbsp;&nbsp;现价:<{$sub_nav_data[sn].products[n].current_price}></div>
            </div>
            <{/section}>
            <{else}>
