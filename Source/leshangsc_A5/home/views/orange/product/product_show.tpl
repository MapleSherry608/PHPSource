	  ...
	  function(){
		  if(!ISLOGIN){
			  ...
			  return false;
			  	...
			  	var id="<{$pro_data.id}>";
			  	$.get(APP_PATH+"/appraise/ajax_check_bought",{id:id},function(data){
	  	...
	  	function(){
			if(!ISLOGIN){
			  ...
			  return false;
				...
				$.ajax({   
					type:"post",     
					url:APP_PATH+"/consult/question",
					data:{pid:pid,user_id:user_id,question:q},
					success:function(msg){
						if(msg==1){
							alert("提问成功，等待管理员回复!");
							$("#question").val("");
        ...
        <div class="right_box">
            ...
            <div class="price_box">
                ...
                <div class="price">
                    ...
                    <p class="origin">原价:&yen;<span class="s" id="origin_price"><{$pro_data.origin_price}></span>&nbsp;&nbsp;&nbsp;运费:&yen;<{$pro_data.delivery_fee}></p>
                </div>
                <div class="clear"></div>
            </div>
            <div class="class_box">
    ...
    <div class="right">
    	<div class="detail_box">
            ...
            <div class="content" id="con_zx" style="display:none;">
            	<div class="qa_box">
                	<{section name=sn loop=$consult_data}>
                	<ul style="border-top:1px dotted #ccc;padding:5px;">
                    	<li><strong style='color:red'><{$consult_data[sn].user.user_name}>咨询：</strong><span style='color:red'><{$consult_data[sn].question}></span>&nbsp;&nbsp;<{$consult_data[sn].q_time|date_format:'%Y-%m-%d %H:%M:%S'}></li>
                        <li><strong style='color:green'>管理员回答：</strong><{if $consult_data[sn].answer}><span style='color:green'><{$consult_data[sn].answer}></span>&nbsp;&nbsp;<{$consult_data[sn].a_time|date_format:'%Y-%m-%d %H:%M:%S'}><{else}>暂无<{/if}></li>
                    </ul>
                    <{/section}>
                </div>
