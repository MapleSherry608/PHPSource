...
<div class="info" style="overflow-y:scroll;">
      ...
      <tr>
        <td width="11%" align="right" class="left_color">合作者身份ID</td>
        <td width="89%" align="left"  class="body_color"><input name="partner_id" type="text" class="input_box" value="<{$datas.partner_id}>"/></td>
      </tr>
      <tr>
        <td width="11%" align="right" class="left_color">安全校验码(Key)</td>
        <td width="89%" align="left"  class="body_color"><input name="authkey" type="text" class="input_box" value="<{$datas.authkey}>"/></td>
      </tr>
      <tr>
        <td width="11%" align="right" class="left_color">支付宝交易手续费</td>
        <td width="89%" align="left"  class="body_color"><input name="fee" type="text" class="input_box" value="<{$datas.fee}>"/>%</td>
      </tr>
      <tr>
        <td width="11%" align="right" class="left_color">支付宝帐号</td>
        <td width="89%" align="left"  class="body_color"><input name="parameter1" type="text" class="input_box" value="<{$datas.parameter1}>"/></td>
      </tr>
      <tr>
        <td width="11%" align="right" class="left_color">交易类型</td>
        <td width="89%" align="left"  class="body_color"><select name="parameter2">
        <option value="1" <{if $datas.parameter2==1}> selected="selected" <{/if}>>即时到账收款</option>
        <option value="2" <{if $datas.parameter2==2}> selected="selected" <{/if}>>担保交易收款</option>
        <option value="3" <{if $datas.parameter2==3}> selected="selected" <{/if}>>双功能收款</option>
        </select></td>
      </tr>
      <tr>
