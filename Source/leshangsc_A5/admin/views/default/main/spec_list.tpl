...
<body>
<form enctype="multipart/form-data" action="<{$app}>/spec/del" method="post">
<div class="info_bar"><div class="title_left"></div><div class="title_bg">·&nbsp;规格管理</div></div>
<div class="info" style="overflow-y:scroll;">
	<{if $datas}>
      ...
      <tr>
        ...
        <td align="center" class="body_color"><strong><{$datas[sn].name}></strong></td>
        <td align="center" class="body_color"><{$datas[sn].sort}></td>
        <td align="center" class="body_color"><a href="<{$app}>/spec/mod_show/id/<{$datas[sn].id}>">编辑</a>&nbsp;&nbsp;<a href="<{$app}>/spec/del/id/<{$datas[sn].id}>" onClick="return confirm('你确定要删除选中的分类吗?')" >删除</a></td>
      </tr>
      <{if $datas[sn].sub}>
      ...
      <tr>
        ...
        <td align="center" class="body_color">&nbsp;&nbsp;&nbsp;&nbsp;└<{$datas[sn].sub[n].name}></td>
        <td align="center" class="body_color"><{$datas[sn].sub[n].sort}></td>
        <td align="center" class="body_color"><a href="<{$app}>/spec/mod_show/id/<{$datas[sn].sub[n].id}>">编辑</a>&nbsp;&nbsp;<a href="<{$app}>/nav/del/id/<{$datas[sn].sub[n].id}>" onClick="return confirm('你确定要删除选中的分类吗?')" >删除</a></td>
      </tr>
      <{/section}>
      <{/if}>
      <{/section}>
...
<div class="fun_bar">
	<div class="oper"><input type="button" name="add" class="admin_button" value="新增" onClick="window.location.href='<{$app}>/spec/add_show'"/>&nbsp;<input type="submit" name="dels" class="admin_button" value="删除" onClick="return confirm('你确定要删除选中的分类吗?')" /></div>
