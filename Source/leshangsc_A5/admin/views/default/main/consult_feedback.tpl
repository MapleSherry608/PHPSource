...
<body>
<form enctype="multipart/form-data" action="<{$app}>/consult/mod" method="post">
<div class="info_bar"><div class="title_left"></div><div class="title_bg">·&nbsp;回复咨询</div></div>
<div class="info" style="overflow-y:scroll;">
      ...
      <tr>
        <td width="11%" align="right" class="left_color">咨询时间</td>
        <td width="89%" align="left"  class="body_color"><{$datas.q_time|date_format:"%Y-%m-%d %H:%M:%S"}></td>
        </tr>
      <tr>
      <tr>
        <td width="11%" align="right" class="left_color">内容</td>
        <td width="89%" align="left"  class="body_color"><{$datas.question}></td>
      </tr>
      <tr>
        <td width="11%" align="right" class="left_color">回复</td>
        <td width="89%" align="left"  class="body_color"><textarea name="answer" cols="80" rows="5"><{$datas.answer}></textarea></td>
      </tr>
      <tr>
