...
<body>
<form enctype="multipart/form-data" action="<{$app}>/group/mod" method="post">
<div class="info_bar"><div class="title_left"></div><div class="title_bg">·&nbsp;编辑用户分组</div></div>
<div class="info">
      ...
      <tr>
        <td width="20%" align="right" class="left_color">积分</td>
        <td width="80%" align="left"  class="body_color"><input name="score" type="text" class="input_box" value="<{$datas.score}>"/></td>
        </tr>
      <tr>
