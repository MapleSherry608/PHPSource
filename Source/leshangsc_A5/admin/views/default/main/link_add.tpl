...
<body>
<form enctype="multipart/form-data" action="<{$app}>/link/add" method="post">
<div class="info_bar"><div class="title_left"></div><div class="title_bg">·&nbsp;添加友情链接</div></div>
<div class="info">
      ...
      <tr>
        <td width="11%" align="right" class="left_color">链接地址</td>
