...
<div class="header-title lr10">
	...
	<span class="lr10"> | </span>
    <b><a href="http://www.smsbao.com/reg?r=10318" target="_blank"><span class="on">短信宝账号注册</span></a><b>
	<span class="lr10"> | </span>
	<b><a href="http://pan.baidu.com/s/1dEBzZmp" target="_blank"><span>短信宝平台设置教程</span></a><b>
...
<table width="100%" class="meg_table">
    ...
    <tr>
    	<td width="100">短信接口mid：</td> 
   		<td><input type="text" name="mid" class="input-text wid150"  value="<?php echo $mobiles['cfg_mobile_2']['mid']; ?>">
		如需注册短信宝账号请点 <a href="http://www.smsbao.com/reg?r=10318" target="_blank"><span class="on">申请账号</span></a></td>
    </tr>
    <tr>
    	<td width="100">短信接口pass：</td> 
   		<td><input type="password" name="mpass" class="input-text wid150"  value="******">
		如要修改密码请点 <a href="http://www.smsbao.com/password/find.jhtml" target="_blank"><span >修改密码</span></a></td>
    </tr>
	<tr>
    	<td width="100">短信签名：</td>
		 ...
		 请在联系科技狗云购官方获取! 格式为: <font color="red">【你的签名】</font>
		</td>
    </tr>
     <tr>
