...
<div class="footer" style="height:auto;">
	<div class="footer_links">
		<?php echo Getheader('foot'); ?><a href="http://www.techgou.com">网站建设</a><b></b><a href="http://www.techgou.com">云购源码</a><b></b>
  	</div>
	<div><p>技术支持：<a href="http://www.techgou.com">河南科技狗网络技术有限公司</p></div>
...
.float_slogan {position: absolute; background: url("/images/footer_ad.png") 0 0 no-repeat;}
...
<div class="float_mask" id="float_mask">
    ...
    <div class="float_content clearfix">
        <div class="float_bg">
            <a target="_blank" href="http://www.techgou.com" title='广告部分'>
