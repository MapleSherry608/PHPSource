...
<body>
<form enctype="multipart/form-data" action="<{$app}>/nav/mod" method="post">
<div class="info_bar"><div class="title_left"></div><div class="title_bg">·&nbsp;编辑导航</div></div>
<div class="info" style="overflow-y:scroll;">
      ...
      <tr>
       ...
       <tr>
        ...
        <{section name=sn loop=$main_list}>
            <option value="<{$main_list[sn].id}>" <{if $main_list[sn].id==$datas.pid}> selected="selected" <{/if}>><{$main_list[sn].name}></option>
        <{/section}>
       ...
       <tr>
        ...
        <select name="module_id">
             ...
             <option value="<{$module_list[sn].id}>" <{if $module_list[sn].id==$datas.module_id}> selected="selected" <{/if}>><{$module_list[sn].name}></option>
         	<{/section}>
        </select><span class="tips">*</span></td>
      </tr>
      <tr>
	  ...
	  <tr>
        ...
        <td align="left" class="body_color"><input name="display" type="radio" value="1" <{if $datas.display==1}>checked="checked"<{/if}> />显示&nbsp;&nbsp;<input name="display" type="radio" value="0"  <{if $datas.display==0}>checked="checked"<{/if}>/>隐藏</td>
        </tr>
      <tr>
