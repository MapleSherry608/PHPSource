...
<body>
<form enctype="multipart/form-data" action="<{$app}>/brand/mod" method="post">
<div class="info_bar"><div class="title_left"></div><div class="title_bg">·&nbsp;编辑品牌</div></div>
<div class="info">
      ...
      <tr>
        ...
        <td width="89%" align="left"  class="body_color"><textarea name="description" cols="80" rows="5"><{$datas.description}></textarea></td>
      </tr>
      <tr>
