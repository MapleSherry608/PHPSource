...
<body>
<form enctype="multipart/form-data" action="<{$app}>/group/add" method="post">
<div class="info_bar"><div class="title_left"></div><div class="title_bg">·&nbsp;添加用户分组</div></div>
<div class="info">
      ...
      <tr>
        ...
        <select name="pid" id="pid">
         <option value="0" selected="selected">一级分组</option>
        <{section name=sn loop=$main_list}>
            <option value="<{$main_list[sn].id}>"><{$main_list[sn].name}></option>
        <{/section}>
        </select><span class="tips">*</span></td>
      </tr>
      <tr>
        <td width="20%" align="right" class="left_color">积分</td>
        <td width="80%" align="left"  class="body_color"><input name="score" type="text" class="input_box" value="0"/></td>
        </tr>
      <tr>
