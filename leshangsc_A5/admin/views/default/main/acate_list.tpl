...
<body>
<form enctype="multipart/form-data" action="<{$app}>/acate/del" method="post">
<div class="info_bar"><div class="title_left"></div><div class="title_bg">·&nbsp;广告分类管理</div></div>
<div class="info" style="overflow-y:scroll;">
	<{if $datas}>
      ...
      <tr>
        ...
        <td align="center" class="body_color"><a href="<{$app}>/acate/edit_show/id/<{$datas[sn].id}>">编辑</a>&nbsp;&nbsp;<a href="<{$app}>/acate/del/id/<{$datas[sn].id}>" onClick="return confirm('你确定要删除选中的分类吗?')" >删除</a></td>
      </tr>
      <{/section}>
      </table>
	<{else}>
...
<div class="fun_bar">
	<div class="oper"><input type="button" name="add" class="admin_button" value="新增" onClick="window.location.href='<{$app}>/acate/add_show'"/>&nbsp;<input type="submit" name="dels" class="admin_button" value="删除" onClick="return confirm('你确定要删除选中的分类吗?')" /></div>
