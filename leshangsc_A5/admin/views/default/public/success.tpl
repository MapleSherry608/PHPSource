<html>
	<head>
		...
		<style type="text/css">
			body {font-family:"microsoft yahei";background:url(<{$res}>/images/corner.gif) no-repeat left top #f3f3f3 fixed; }
			...
			#notice .content .mess{width:380px;height:204px;float:left;line-height:20px;font-size:17px;}
	...
	<body>
    	<div id="notice">
            ...
            <div class="content">
            	<div class="sign"  style="background:url(<{$public}>/images/outbox.jpg) no-repeat;"><{if $mark}><span style="color:green;">√</span><{else}><span style="color:red">×</span><{/if}>	</div>
                <div class="mess"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td valign="middle"><{$mess}></td>
  </tr>
</table>
</div>
            </div>
