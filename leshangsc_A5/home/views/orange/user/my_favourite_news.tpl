...
$(document).ready(function(e) {
	...
	$(".del").click(function(){
		 if(confirm("确定要删除吗")){
			 var id=$(this).attr("id");
			 window.location.href=APP_PATH+"/user/del_fav_news/id/"+id;
		 }else{
			 return false;
		 }
	});
            	...
            	<div class="orders_box">
                	<ul>
                    	...
                    	<li>
                            ...
                            <span>●&nbsp;名称：<font title="<{$datas[sn].title}>" class="red_l"><a href="<{$datas[sn].url}>" target="_blank"><{$datas[sn].title|truncate:"75"}></a></font></span>
