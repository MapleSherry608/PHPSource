...
$(document).ready(function(e) {
	...
	$(".del").click(function(){
		 if(confirm("确定要删除吗")){
			 var id=$(this).attr("id");
			 window.location.href=APP_PATH+"/user/del_consult/id/"+id;
		 }else{
			 return false;
		 }
	});
            	...
            	<div class="orders_box">
                	<ul>
                    	...
                    	<li>
                            ...
                            <span style="color:green">提问内容：<font title="<{$datas[sn].question}>"><{$datas[sn].question|truncate:"10"}></font></span>
                            <span style="color:green">提问时间:<{$datas[sn].q_time}></span>
                            <span style="color:green"><{if $datas[sn].is_reply}><font title="<{$datas[sn].answer}>&#10;回复时间：">已回复</font><{else}><font style="color:red">未回复</font><{/if}></span>
