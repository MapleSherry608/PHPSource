    ...
    <div class="news_list_box">
        ...
        <div class="n_cont">
        	...
        	<ul>
            	...
            	<li><a href="<{$news_datas[sn].url}>"><{$news_datas[sn].title|truncate:52:"...":true}></a>&nbsp;&nbsp;<span style="color:#006600">(<{$news_datas[sn].create_time}>)</span><p><{$news_datas[sn].description}></p><div class="user">发布用户:<span class="uname_box"><{$news_datas[sn].user_info.user_name}>
               
                <div class="user_private_list"><ul><li><a class="letter" data-name="<{$news_datas[sn].user_info.user_name}>" id="<{$news_datas[sn].user_info.id}>">发私信</a></li><li><a class="friend" id="<{$news_datas[sn].user_info.id}>">加好友</a></li></ul></div></span></div></li>
                <{/section}>
            </ul>
            <div class="page">
            	<{$fpage}>
