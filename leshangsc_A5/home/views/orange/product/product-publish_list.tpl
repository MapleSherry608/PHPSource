    ...
    <div class="product_box">
        ...
        <div class="content_list" id="products">
        	...
        	<div class="product">
                ...
                <div class="p_price">价格:&yen;<{$product_datas[sn].current_price}></div>
                 <div class="p_price ">发布会员:<span class="uname_box"><{$product_datas[sn].user_info.user_name}>
               
                <div class="user_private_list"><ul><li><a class="letter" data-name="<{$product_datas[sn].user_info.user_name}>" id="<{$product_datas[sn].user_info.id}>">发私信</a></li><li><a class="friend" id="<{$product_datas[sn].user_info.id}>">加好友</a></li></ul></div></span></div>
            </div>
