...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<{$res}>/css/jquery.mobile.flatui.css" />
...
<body>
 ...
 <div data-role="page">
    ...
    <div data-role="panel" id="panel" data-position="right" data-theme="none" data-display="reveal" >
		<div class="nav-box">
			<ul>
				<{section name=sn loop=$main_nav}>
				<li><a href="" data-rel="close"><{$main_nav[sn].name}></a></li>
				<{/section}>
			</ul>
		</div>
	</div>
    ...
    <div data-role="content" role="main">
      ...
      <fieldset class="ui-grid-a">
         <div class="ui-block-a"><button data-icon="flat-lock" data-theme="e">商品中心</button></div>
        <div class="ui-block-c"><button data-icon="flat-new" data-theme="b">资讯中心</button></div>
		<div class="ui-block-b"><button data-icon="flat-heart" data-theme="d">品牌中心</button></div>
		<div class="ui-block-c"><button data-icon="flat-man" data-theme="f">会员登录</button></div>
