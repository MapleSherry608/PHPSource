...
function check_dirfile(){
	$items = array(
		...
		array('dir', '可写', 'success', './Application/Member/Conf'),
...
function register_administrator($db, $prefix, $admin, $auth){
	...
	$sql = "INSERT INTO `[PREFIX]user` (`id`,`username`,`status`,`email`,`mobile`,`password`,`sex`,`birthday`,`qq`,`login`,`reg_ip`,`reg_time`,`last_login_ip`,`last_login_time`) VALUES " .
		   "(1,'[NAME]',1,'[EMAIL]','','[PASS]',0,'0000-00-00','',0,0,'[TIME]','[IP]','[TIME]')";
