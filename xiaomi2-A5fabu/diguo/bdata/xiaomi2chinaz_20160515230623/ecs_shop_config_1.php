...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','微信分销商城电脑手机三合一','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','微信分销商城电脑手机三合一','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','微信分销商城电脑手机三合一','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','微信分销商城电脑手机三合一','1');");
...
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','275194004','1');");
...
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','18175863383','1');");
...
E_D("replace into `ecs_shop_config` values('118','1','shop_logo','file','','../themes/{\$template}/images/','../themes/ecmoban_xiaomi2015/images/logo.gif','1');");
E_D("replace into `ecs_shop_config` values('119','1','licensed','select','0,1','','1','1');");
E_D("replace into `ecs_shop_config` values('120','1','user_notice','textarea','','','微信分销商城电脑手机三合一，和七亿人做生意。购买联系：QQ275194004  电话：18175863383 网址：www.htwl168.com','1');");
E_D("replace into `ecs_shop_config` values('121','1','shop_notice','textarea','','','微信分销商城电脑手机三合一，和七亿人做生意。购买联系：QQ275194004  电话：18175863383 网址：www.htwl168.com','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','©mi.com 京ICP证110507号 京ICP备10046444号 京公网安备1101080212535号 京网文[2014]0059-0009号','1');");
...
E_D("replace into `ecs_shop_config` values('306','3','image_width','text','','','360','1');");
E_D("replace into `ecs_shop_config` values('307','3','image_height','text','','','360','1');");
...
E_D("replace into `ecs_shop_config` values('316','3','article_number','text','','','5','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','iPhone,母婴用品','0');");
...
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','ecmoban_xiaomi2015','1');");
E_D("replace into `ecs_shop_config` values('605','6','install_date','hidden','','','1438566589','1');");
