...
.container{width:1200px; margin:0 auto; height:419px; overflow:hidden;position:relative;}
...
.num{position:absolute; right:30px; bottom:20px;}
.num li{
	float: left;
	color: #fa0;
	text-align: center;
...
<div class="container" id="idTransformView">
  ...
  <?php $_from = $this->_var['flash']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'flash_0_01073500_1463324391');$this->_foreach['myflash'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['myflash']['total'] > 0):
    foreach ($_from AS $this->_var['flash_0_01073500_1463324391']):
        $this->_foreach['myflash']['iteration']++;
?>
      <li style="background:url(<?php echo $this->_var['flash_0_01073500_1463324391']['src']; ?>) center 0 no-repeat; position:relative;"><a href="<?php echo $this->_var['flash_0_01073500_1463324391']['url']; ?>" target="_blank"></a></li>
  ...
  <ul class="num" id="idNum">
     ...
     <?php $_from = $this->_var['flash']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'flash_0_01073500_1463324391');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
